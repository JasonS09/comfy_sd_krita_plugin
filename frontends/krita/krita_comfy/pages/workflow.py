...
class WorkflowPage(QWidget):
    ...
    def update_prefix(self):
        #
        self.workflow.setPlainText(script.cfg("workflow", str))

    def cfg_init(self):
        #self.workflow_to.cfg_init()
        #self.workflow_to.qcombo.setEditText(self.prefix)
        if self.workflow.toPlainText() != script.cfg("workflow", str):
            self.update_prefix()
    ...
    def cfg_connect(self):
        ...
        self.workflow.textChanged.connect(
            lambda: script.cfg.set("workflow", self.workflow.toPlainText())
        )
